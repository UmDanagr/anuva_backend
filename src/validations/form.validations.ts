...
export const createFamilyHistoryFormSchema = z.object({
  ...
  parkinsonDisease: z.boolean().optional(),
  learningDisabilities: z.boolean().optional(),
  substanceAbuse: z.boolean().optional(),
  otherConditions: z.string().optional(),
});

export const createSubstanceUseHistoryFormSchema = z.object({
  usesAlcohol: z.boolean().optional(),
  alcoholDaysPerWeek: z.number().optional(),
  alcoholDrinksPerOccasion: z.number().optional(),
  alcoholAgeFirstUse: z.number().optional(),
  alcoholAgeLastUse: z.number().optional(),
  alcoholLongestSobriety: z.string().optional(),
  alcoholCurrentlySober: z.boolean().optional(),
  alcoholLastUse: z.string().optional(),
  alcoholBinges: z.boolean().optional(),
  alcoholBlackouts: z.boolean().optional(),
  alcoholDeliriumTremens: z.boolean().optional(),
  alcoholRelatedSeizures: z.boolean().optional(),
  usesNicotine: z.boolean().optional(),
  nicotineAgeFirstUse: z.number().optional(),
  nicotineType: z.string().optional(),
  nicotineAmountPerDay: z.string().optional(),
  nicotineLastUse: z.string().optional(),
  usesSteroids: z.boolean().optional(),
  steroidsAgeFirstUse: z.number().optional(),
  steroidsFrequency: z.string().optional(),
  steroidsDuration: z.string().optional(),
  steroidsLastUse: z.string().optional(),
  usesOtherSubstances: z.boolean().optional(),
  substancesUsed: z.string().optional(),
  substancesAgeFirstUse: z.number().optional(),
  substancesTypicalAmount: z.string().optional(),
  substancesFrequency: z.string().optional(),
  substancesLongestSobriety: z.string().optional(),
